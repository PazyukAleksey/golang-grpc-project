...
type UserServiceClient interface {
	...
	GetUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetAllUsersResponse, error)
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetAllUsersResponse, error) {
...
type UserServiceServer interface {
	...
	GetUsers(context.Context, *Empty) (*GetAllUsersResponse, error)
...
func (UnimplementedUserServiceServer) GetUsers(context.Context, *Empty) (*GetAllUsersResponse, error) {
